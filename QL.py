...
def save_csv(dict_list, filename):
    with open(filename, 'a', newline='') as f:
        writer = csv.DictWriter(f, fieldnames=['api_time','id', 'q-value', 'phase', 'episode', 'xaviernx_time_elapsed', 'ql_time_elapsed', 'cpu_cores', 'cpu_freq', 'gpu_freq', 'memory_freq', 'cl', 'elapsed','throughput', 'power_cons', 'cpu_percent', 'gpu_percent', 'mem_percent'])
